...
description: Transforms vague UI ideas into polished, Stitch-optimized prompts for stitch-orchestrator. Enhances specificity, adds UI/UX keywords, injects design-system context, and structures output for better generation results.
allowed-tools:
  - "Read"
  - "Write"
---
...
file using the `stitch-design-md` or `stitch-extract-design-md` skill. This ensures all generated pages share the 
...
- `.stitch/next-prompt.md` — for use in baton-style iterative Stitch workflows
...
---
💡 **Tip:** For consistent designs across multiple screens, create a DESIGN.md 
file using the `stitch-design-md` or `stitch-extract-design-md` skill.
```
